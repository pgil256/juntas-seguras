...
const connectDB = async () => {
  try {
    await mongoose.connect(process.env.MONGODB_URI || 'mongodb+srv://gilhooleyp:***REMOVED***@cluster0.b41mpyd.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0');
