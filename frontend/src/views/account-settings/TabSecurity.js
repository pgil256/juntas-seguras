    ...
    <form>
            ...
            <Grid container spacing={5}>
              <Grid item xs={12} sx={{ marginTop: 4.75 }}>
                <FormControl fullWidth>
                  <InputLabel htmlFor='account-settings-current-password'>{t('CurrentPassword')}</InputLabel>
                  <OutlinedInput
              ...
              <Grid item xs={12} sx={{ marginTop: 6 }}>
                <FormControl fullWidth>
                  <InputLabel htmlFor='account-settings-new-password'>{t('NewPassword')}</InputLabel>
                  <OutlinedInput
                    label={t('NewPassword')}
              ...
              <Grid item xs={12}>
                <FormControl fullWidth>
                  <InputLabel htmlFor='account-settings-confirm-new-password'>{t('ConfirmNewPassword')}</InputLabel>
                  <OutlinedInput
      ...
      <CardContent>
        <Box sx={{ mt: 1.75, display: 'flex', alignItems: 'center' }}>
          ...
          <Typography variant='h6'>{t('Two-factor authentication')}</Typography>
        </Box>
